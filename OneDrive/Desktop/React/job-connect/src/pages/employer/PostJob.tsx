  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      if (!companyData) {
        ...
        throw new Error('Company not found. Please set up your company profile first.');
      }
      ...
      const jobData = {
        ...
        minimum_education: formData.minimumEducation === 'custom' ? formData.customEducation : formData.minimumEducation,
        language_requirement: formData.languageRequirement === 'custom' ? formData.customLanguage : formData.languageRequirement,
        experience_type: formData.experienceType,
        minimum_experience: formData.minimumExperience === 'custom' ? formData.customExperience : formData.minimumExperience,
      ...
      const { data: insertedData, error: jobError } = await supabase
        .from('jobs')
        .insert([jobData])
        .select();
