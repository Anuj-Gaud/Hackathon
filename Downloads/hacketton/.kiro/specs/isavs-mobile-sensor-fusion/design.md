...
This design document specifies the architecture and implementation details for adding hardware-level proximity and liveness verification to ISAVS 2026 through a React Native mobile application. The system leverages smartphone sensors (BLE, Accelerometer, Gyroscope, GPS, Barometer) to create a multi-layered, sensor-fused verification system.
